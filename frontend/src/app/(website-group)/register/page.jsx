        ...
        <>
            <section className='w-full md:min-w-[510px] bg-white rounded-[10px] my-4'>
                <ul className='max-w-[1300px] m-full md:min-w-[510px] text-[12px] md:text-[14px] text-[#999999] font-bold list-none flex items-center capitalize gap-x-2 p-5 md:py-6 md:px-6 lg:px-9'>
                    ...
                    <Link href={"/register"} className='hover:cursor-pointer text-black'> register</Link>
                </ul>
            </section >
            {/* breadcrumb section */}
                ...
                <section className='max-w-[1300px] mx-auto md:min-w-[510px] flex-col lg:flex lg:flex-row justify-center lg:justify-around py-5 md:py-8 lg:py-12'>
                    ...
                    <div className='px-4 sm:px-5 md:px-10 lg:px-0'>
                        ...
                        <div className='mt-4 sm:mt-5 md:mt-6 lg:mt-7 '>
                            ...
                            <input className='outline-0 border border-[#CCCCCC] rounded-md p-2 capitalize w-full md:min-w-[510px] placeholder:text-[#999999] text-[12px] md:text-[14px] px-3'
                                type="text"
                        ...
                        <div className='mt-4 sm:mt-5 md:mt-6 lg:mt-7 '>
                            ...
                            <div className='flex items-center justify-between border border-[#CCCCCC] rounded-md p-2 px-3 w-full md:min-w-[510px]'>
                                ...
                                <FaEyeSlash className='hover:cursor-pointer' />
                            </div>
                        </div>
                        {/* confirm input */}

                        <button className='bg-[#01A49E] text-white font-medium uppercase text-[12px] md:text-[14px] rounded-md py-3 px-4 sm:px-6 md:px-8 mt-6 md:mt-10 hover:cursor-pointer'>register</button>

                        <p className='text-[#999999] text-[12px] md:text-[13px] font-normal uppercase mt-2.5'>already user?
