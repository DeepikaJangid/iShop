                ...
                <form
                    ...
                    <div>
                        ...
                        <input
                            ref={brandRef}
                            onChange={createSlug}
                            className="mt-2 w-full rounded-lg border border-slate-200 px-3 py-2 text-sm capitalize" placeholder="e.g. Always Wonder" />
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ref={ownerRef}
                            className="mt-2 w-full rounded-lg border border-slate-200 px-3 py-2 text-sm capitalize" placeholder="e.g. LingLing Kwong" />
                    </div>
