        ...
        <div className="min-h-screen bg-gray-50 p-6 sm:p-10">
            <div className="max-w-5xl mx-auto">
                ...
                <form
                    ...
                    className="grid grid-cols-1 gap-6 md:grid-cols-3" aria-labelledby="edit-category-form">
                    {/* Left: main fields */}
                    <section className="md:col-span-full rounded-2xl bg-white p-6 shadow-md">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    defaultValue={category?.name} //edit form mein pehle se data filled rehta hai to uske liye...har ek input ki default value hoti hai to woh already fill rakhega jo bhi us category ka naam hai
                            ...
                            <div>
                                ...
                                <div className="flex flex-col items-center gap-4">
                                    ...
                                    <img
                                        className="shadow-2xl rounded-lg max-w-50"
                                        src={selectedImage || imageURL} alt="Edit Image" />
                                    {/* src={imageURL} alt="Edit Image" /> */}
                                    <p className="mt-1 text-xs text-slate-400">Edit your category image (JPG, PNG, or GIF, max 3MB).</p>
                                </div>
                            </div>

                            <button type="submit" className="inline-flex items-center justify-center gap-2 rounded-lg px-4 py-2 text-sm font-semibold text-white shadow-sm bg-slate-900 hover:bg-slate-800 hover:cursor-pointer">Save Category Changes</button>
                        </div>
                    </section>
