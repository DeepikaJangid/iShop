...
export default function ColorEdit({ colorData }) {
    const [color, setColor] = React.useState(colorData.code);
                ...
                <label className="col-span-3 flex flex-col">
                    ...
                    <div className="mt-2 flex gap-3 items-center">
                        <input
                            value={color}
                            onChange={(e) => {
                                let userInputCode = e.target.value;
                                if (userInputCode[0] !== '#') userInputCode = '#' + userInputCode;
                                setColor(userInputCode);
                            }}
                            placeholder="#HexCOde"
