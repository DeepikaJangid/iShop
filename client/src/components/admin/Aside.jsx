...
import { FaTachometerAlt, FaBoxOpen, FaShoppingCart, FaUsers, FaCog, FaTags, } from "react-icons/fa";
...
export default function AdminSidebar() {
    ...
    const menuItems = [
        ...
        { label: "Brands", icon: <HiOutlineCollection />, path: "/admin/brand" },
        { label: "Products", icon: <FaBoxOpen />, path: "/admin/product" },
