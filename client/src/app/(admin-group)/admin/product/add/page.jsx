...
export default function AddProductPage() {
    ...
    const submitHandler = (event) => {
        ...
        // console.log('original_price', originalPriceRef.current.value);
        // console.log('discount', discountPercentRef.current.value);
        // console.log('final_price', finalPriceRef.current.value);
        // return;
                ...
                <div className="xl:col-span-2 space-y-6">
                    ...
                    <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="md:col-span-2">
                                ...
                                <Editor onTextChange={(d) => setDescription(d.htmlValue)} style={{ height: "200px", borderColor: "#E5E7EB", borderBottomLeftRadius: "8px", borderBottomRightRadius: "8px", }} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
                        ...
                        <div className="border border-gray-200 rounded-lg p-6 text-center hover:cursor-pointer">
                            ...
                            <FileUpload onFilesChange={getFile} className="mt-4" maxSize={2 * 1024 * 1024} maxFiles={1} />
                        </div>
                    </div>
                </div>
